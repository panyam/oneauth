...
require (
	...
	github.com/panyam/oneauth/stores/gae v0.1.33
...
replace github.com/panyam/oneauth/stores/gorm => ../../stores/gorm

replace github.com/panyam/oneauth/stores/gae => ../../stores/gae

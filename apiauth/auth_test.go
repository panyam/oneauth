...
func TestRefreshTokenGrant(t *testing.T) {
	...
	var loginResponse core.TokenPair
	...
	t.Run("successful refresh", func(t *testing.T) {
		...
		var refreshResponse core.TokenPair
...
func TestCustomClaimsInContext(t *testing.T) {
	...
	t.Run("ValidateToken stores custom claims", func(t *testing.T) {
		...
		testHandler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			capturedClaims = apiauth.GetCustomClaimsFromContext(r.Context())
			w.WriteHeader(http.StatusOK)
		})

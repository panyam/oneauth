...
sequenceDiagram
    ...
    Note over App,RS: Step 3: Scope step-up with TokenForScopes
...
### Step 1: One-shot token with AuthClient
...
```bash
# What the SDK does under the hood (first call only — subsequent calls reuse the cached token):
...
### Step 3: Scope step-up with TokenForScopes
...
### Step 4: Use the SDK against Keycloak (optional)

...
func TestLoginFlow(t *testing.T) {
	...
	createUser := localauth.NewCreateUserFunc(service.UserStore, service.IdentityStore, service.ChannelStore)
	validateCreds := localauth.NewCredentialsValidator(service.IdentityStore, service.ChannelStore, service.UserStore)
...
func setupPasswordResetAuth(t *testing.T) (*localauth.LocalAuth, *testAuthService, *trackingEmailSender, string) {
	service, tmpDir := setupTestAuth(t)

	createUser := localauth.NewCreateUserFunc(service.UserStore, service.IdentityStore, service.ChannelStore)
	updatePassword := localauth.NewUpdatePasswordFunc(service.IdentityStore, service.ChannelStore)

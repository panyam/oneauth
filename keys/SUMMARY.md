...
- **encrypted.go** — `EncryptedKeyStorage` decorator (AES-256-GCM at rest for HMAC secrets and private PEM blocks; public PEMs pass through plaintext for JWKS exposure)

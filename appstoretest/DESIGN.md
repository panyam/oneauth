...
- **`TestAllFieldsRoundTrip` is the canary for new `AppRegistration` fields.** When a new field is added upstream, this test must be extended or backend serialization gaps will silently ship.
